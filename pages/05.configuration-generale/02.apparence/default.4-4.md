...
**Template de la page de connexion :** Permet de choisir entre la version centré (historique) ou à droite.
**Logo :** Afficher ou non le logo sur la page de connexion.
**Nom de l'établissement :** Afficher ou non le nom de l’établissent sur la page de connexion.
**Image de à faire apparaitre :** Uniquement disponible sur le template 2 (A droite)

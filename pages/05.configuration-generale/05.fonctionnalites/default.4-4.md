...
!!!  Performance : Nouveauté 4.4.0

Cette section permet de désactiver certains calculs pouvant être plus ou moins longs selon le nombre de réservations et la configuration de vos ressources.

#### Options disponibles

- **Calcul plage libre vue semaine ALL** (ON / OFF)  
- **Calcul plage libre vue mois** (ON / OFF)  
- **Calcul plage libre vue mois ALL** (ON / OFF)

#### Fonctionnement

Lorsque une option est réglée sur **OFF**, GRR ne cherche pas à déterminer s'il existe une plage libre.  
Le symbole **"+"** est alors affiché directement afin de permettre l'ajout rapide d'une réservation.

Ces options permettent d'améliorer les performances de l'application sur les environnements contenant un grand nombre de ressources ou de réservations.
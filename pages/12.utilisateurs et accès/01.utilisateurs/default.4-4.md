...
!!! **Nouveauté GRR 4.4.0 :** Désactiver l'envoi de mail à cet utilisateur & Commentaire
...
**Commentaire:** Permet de mettre un texte libre qui est uniquement consultable par le gestionnaire utilisateur et l'administrateur.

**Désactiver l'envoi de mail à cet utilisateur:** L'utilisateur ne recevra plus de mail de GRR. Ce paramètre est prioritaire sur "Mail automatiques"
